...
from auth.services.auth_service import register as svc_register, login as svc_login, refresh as svc_refresh, logout as svc_logout
from db.session import get_db
from api.all_routes.auth_routers.schemas.auth_io import (
    AuthTokensOut,
    LoginIn,
    RefreshIn,
    RegisterIn,
...
async def register(payload: RegisterIn, session: AsyncSession = Depends(get_db)) -> UserOut:
    ...
    try:
        ...
        # Re-raise HTTPException as-is (already has proper status and detail)
